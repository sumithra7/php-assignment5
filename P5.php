...
<form method="post">
	<div class="container " style="box-shadow:5px 5px #beccc5;">
		<center><h1 >ABC Bank</h1>
		<input class="a" type="submit" name="create" value="Create">&nbsp &nbsp
			<input class="a"type="submit" name="deposit" value="Deposit"><br><br>
			<input class="a" type="submit" name="withdraw" value="Withdraw">&nbsp&nbsp
			<input  class="a" type="submit" name="enquiry" value="Balance Enquiry"><br><br></center>
	</div>
</form>
...
<?php 
  ...
  {
	echo"<br><b>Welcome to ABC Bank</b>";
	echo"<b>&nbspCreate your account</b></br>";
	...
	echo"<table border='1'>
		...
		<tr>
			<td colspan='2'><input class='a' type='submit' name='create1' value='Create'>&nbsp<input class='a' type='reset' name='clear' value='Clear'></td>
		</tr>
...
<?php
  ...
  {	
	...
	echo"<input class='a' type='submit' name='submit' value='OK'></form>";
  }
?>
...
<?php
  ...
  if(isset($_POST['withdraw']))
  {
	...
	echo"<input class='a' type='submit' name='submit1' value='OK'></form>";
  }
?>
...
<?php
  ...
  if(isset($_POST['enquiry']))
  {
	...
	echo"<br>Enter the account number";
	echo"<input type='number' name='acno' required><br><br>";
	echo"<input class='a' type='submit' name='submit2' value='OK'></form>";
  }
?>
